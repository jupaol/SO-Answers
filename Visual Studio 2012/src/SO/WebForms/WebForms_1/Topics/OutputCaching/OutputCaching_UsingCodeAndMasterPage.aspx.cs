...
{
    public partial class OutputCaching_UsingCodeAndMasterPage : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            this.Response.Cache.VaryByParams[this.ddl.UniqueID] = true;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                this.ddl.DataSource = Enumerable.Range(10, 20).Select(x => new { Text = "Something" + x.ToString(), Value = x });
                this.ddl.DataBind();
            }

            this.Form.DefaultFocus = this.ddl.ClientID;
